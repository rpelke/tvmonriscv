...
nn_name = 'mnist_cnn'
cc_path = '/scratch/pelke/tools/arm-gnu-toolchain-13.2.Rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-g++'
model = tf.keras.models.load_model(f'{repo_path}/models/{nn_name}.h5')
lib_name = build_lq_lib(model, nn_name=nn_name, batch=16, store_path=f'{repo_path}/models', cc=cc_path)
